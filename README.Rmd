...
A `modeltime` extension that implements ___forecast resampling tools___ for making iterative predictions and evaluating resample results with the __goal of assessing model performance and stability over time.__
