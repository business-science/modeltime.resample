...
```{r, echo=F, out.width='80%', fig.cap="Model Accuracy for 6 Time Series Resamples"}
...
3. [Resampling Panel Data](https://business-science.github.io/modeltime.resample/articles/getting-started-with-modeltime-resample.html): An advanced tutorial on resample evaluation with multiple __time series groups (Panel Data)__
