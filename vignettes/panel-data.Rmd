...
__The first step is to make a resample strategy.__ Our business objective is to forecast 3 months so we'll use the following strategy:
...
Working with Panel Data (data with multiple overlapping time series groups) can be challenging due to managing multiple models, overlapping time series groups, and multiple resample sets. 
