...
Here is an example from [_Resampling Panel Data_](https://business-science.github.io/modeltime.resample/articles/articles/panel-data.html), where we can see that Prophet Boost and XGBoost Models outperform Prophet with Regressors for the Walmart Time Series Panel Dataset using the 6-Slice Time Series Cross Validation plan shown above. 
...
3. [Resampling Panel Data](https://business-science.github.io/modeltime.resample/articles/articles/panel-data.html): An advanced tutorial on resample evaluation with __multiple time series groups (Panel Data)__
